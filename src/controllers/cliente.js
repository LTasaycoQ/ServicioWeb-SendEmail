...
function buildEmailCliente(d) {
  ...
  const filasHab = habs.length ? habs.map(([l, v]) => emailFila(l, v)).join('') : `<tr><td style="padding:9px 0;color:#888;font-size:13px;">Sin habitaciones seleccionadas</td></tr>`;
  const filasPax = d.pasajeros.length ? d.pasajeros.map((p, i) => `
        <tr>
        ...
        </tr>`).join('') : `<tr><td style="padding:9px 0;color:#888;font-size:13px;">Sin pasajeros registrados</td></tr>`;
  ...
  const cuerpo = `
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#fafafa;border-left:4px solid #795c41;border-radius:4px;margin-bottom:28px;">
      <tr><td style="padding:20px 24px;"><table width="100%" cellpadding="0" cellspacing="0">\${emailFila('Fecha de registro', d.fecha)}\${emailFila('Referencia', d.referencia)}\${emailFila('Adultos', d.adultos)}\${emailFila('Niños', d.ninos)}</table></td></tr>
    </table>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#fafafa;border-left:4px solid #795c41;border-radius:4px;margin-bottom:28px;">
      <tr><td style="padding:20px 24px;"><table width="100%" cellpadding="0" cellspacing="0">\${filasHab}</table></td></tr>
    </table>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#fafafa;border-left:4px solid #795c41;border-radius:4px;margin-bottom:28px;">
      <tr><td style="padding:20px 24px;"><table width="100%" cellpadding="0" cellspacing="0">\${filasPax}</table></td></tr>
    </table>`;
